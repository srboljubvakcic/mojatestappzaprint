...
import { ArrowLeft, Download, Trash2, FileImage } from "lucide-react";
...
function OrderDetail() {
  ...
  const downloadAll = async () => {
    ...
    try {
      ...
      a.href = url;
      a.download = `narudzba-${order.id.slice(0, 8)}.zip`;
      a.click();
    ...
    <div className="p-6 sm:p-10">
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-[1fr_320px]">
        <div className="space-y-6">
          <Section title="Slike narudžbe" actions={
            <Button variant="outline" size="sm" onClick={downloadAll} className="rounded-full">
